...
import { Dimensions, Platform, Alert, ScrollView, View, Text, Image } from 'react-native';
import { Permissions, Notifications, Util, AppLoading }  from 'expo';
import { Button, Card, CardItem, CardBody } from 'native-base';
    ...
    render() {
        ...
        return (
            <ScrollView>
              ...
              />
              <View style={{flex: 1}}>
                <Button full transparent><Text>BROWSE MORE SERMONS</Text></Button>
              </View>
              <View style={{flex: 1}}>
